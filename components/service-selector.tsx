    ...
    <Card className="overflow-hidden border-2 border-primary/20 shadow-2xl hover:shadow-glow-lg transition-all duration-300">
      ...
      <CardContent className="space-y-4 pt-6">
        ...
        >
          <Label
            htmlFor="delivery"
            className={`group relative flex items-center space-x-4 rounded-2xl border-2 p-6 cursor-pointer transition-all duration-300 overflow-hidden ${serviceType === "delivery"
                ? "border-primary bg-gradient-to-br from-primary/10 to-destructive/10 shadow-lg scale-[1.02]"
                : "border-border hover:border-primary/50 hover:shadow-md hover:scale-[1.01]"
              }`}
          >
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-destructive/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            ...
            <div className="flex items-center gap-4 flex-1 z-10">
              <div className={`flex items-center justify-center h-16 w-16 rounded-2xl transition-all duration-300 ${serviceType === "delivery"
                  ? "bg-gradient-to-br from-primary to-destructive shadow-lg shadow-primary/50"
                  : "bg-gradient-to-br from-primary/20 to-destructive/20 group-hover:from-primary/30 group-hover:to-destructive/30"
                }`}>
          ...
          <Label
            htmlFor="restaurant"
            className={`group relative flex items-center space-x-4 rounded-2xl border-2 p-6 cursor-pointer transition-all duration-300 overflow-hidden ${serviceType === "restaurant"
                ? "border-secondary bg-gradient-to-br from-secondary/10 to-accent/10 shadow-lg scale-[1.02]"
          ...
          >
            ...
            <div className="flex items-center gap-4 flex-1 z-10">
              <div className={`flex items-center justify-center h-16 w-16 rounded-2xl transition-all duration-300 ${serviceType === "restaurant"
                  ? "bg-gradient-to-br from-secondary to-accent shadow-lg shadow-secondary/50"
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">Pasa a recoger tu pedido</p>
              </div>
            </div>
          </Label>
        </RadioGroup>
        ...
        <Button
          ...
          className="w-full mt-6 h-14 text-lg font-extrabold bg-gradient-to-r from-primary via-destructive to-secondary hover:shadow-glow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02]"
          size="lg"
        >
