...
import { pizzas2x1, complementosCarrusel } from "@/config/menu.config"
...
export function ProductCarousel({ category = "2x1" }: ProductCarouselProps) {
  ...
  const products = category === "2x1" ? pizzas2x1 : complementosCarrusel
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold text-foreground">
          {category === "2x1" ? "Pizzas 2x1 - Especialidades" : "Paquetes de Spaguetti"}
        </h2>
