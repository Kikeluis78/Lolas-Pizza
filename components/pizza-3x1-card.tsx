    ...
    <div className="space-y-6">
      ...
      <Card className="border-2 bg-gradient-to-br from-card to-accent/5">
        ...
        <div className="border-t pt-4 space-y-3">
          <div className="space-y-1 text-center bg-accent/5 p-4 rounded-lg">
            {extraTotal > 0 && (
              <p className="text-xs font-semibold text-accent">
                Extras: +${extraTotal}
              </p>
            )}
            <p className="text-3xl font-bold text-accent">${finalPrice}</p>
            <p className="text-xs text-muted-foreground">Promoción 3x1</p>
          </div>
          <Button 
            onClick={handleAddToCart} 
            className="w-full h-12 text-lg font-bold bg-gradient-to-r from-accent via-secondary to-primary text-white hover:from-accent/90 hover:via-secondary/90 hover:to-primary/90 shadow-md hover:shadow-glow transition-all duration-200 hover:scale-105"
          >
            Agregar al Carrito
          </Button>
        </div>
