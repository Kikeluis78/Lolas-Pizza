...
export function PizzaSelectionModal({ isOpen, onClose, pizza, allEspecialidades }: PizzaSelectionModalProps) {
  ...
  const has3x1 = especialidades3x1.length > 0 && pizzeriaConfig.features.promo3x1
  const has2x1 = pizzeriaConfig.features.promo2x1
  const { orillasRellenas, mitadYMitad } = pizzeriaConfig.features
        ...
        {mode === "select-mode" ? (
          ...
          <div className="space-y-6 py-2">
            ...
            <div className="space-y-3 pt-2 border-t">
               ...
               {mitadYMitad && pizzaType === "mitad-y-mitad" && (
